...
class ClosedPosition(db.Model):
    ...
    # Результаты
    realized_pnl = db.Column(db.Numeric(20, 8), nullable=False)  # Реализованная прибыль/убыток
    return_percentage = db.Column(db.Numeric(10, 4), nullable=False)  # Доходность в %
